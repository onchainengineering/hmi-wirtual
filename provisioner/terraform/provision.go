...
func provisionEnv(
	...
	env = append(env,
		"WIRTUAL_AGENT_URL="+metadata.GetCoderUrl(),
		"WIRTUAL_WORKSPACE_TRANSITION="+strings.ToLower(metadata.GetWorkspaceTransition().String()),
		"WIRTUAL_WORKSPACE_NAME="+metadata.GetWorkspaceName(),
		"WIRTUAL_WORKSPACE_OWNER="+metadata.GetWorkspaceOwner(),
		"WIRTUAL_WORKSPACE_OWNER_EMAIL="+metadata.GetWorkspaceOwnerEmail(),
		"WIRTUAL_WORKSPACE_OWNER_NAME="+metadata.GetWorkspaceOwnerName(),
		"WIRTUAL_WORKSPACE_OWNER_OIDC_ACCESS_TOKEN="+metadata.GetWorkspaceOwnerOidcAccessToken(),
		"WIRTUAL_WORKSPACE_OWNER_GROUPS="+string(ownerGroups),
		"WIRTUAL_WORKSPACE_OWNER_SSH_PUBLIC_KEY="+metadata.GetWorkspaceOwnerSshPublicKey(),
		"WIRTUAL_WORKSPACE_OWNER_SSH_PRIVATE_KEY="+metadata.GetWorkspaceOwnerSshPrivateKey(),
		"WIRTUAL_WORKSPACE_OWNER_LOGIN_TYPE="+metadata.GetWorkspaceOwnerLoginType(),
		"WIRTUAL_WORKSPACE_ID="+metadata.GetWorkspaceId(),
		"WIRTUAL_WORKSPACE_OWNER_ID="+metadata.GetWorkspaceOwnerId(),
		"WIRTUAL_WORKSPACE_OWNER_SESSION_TOKEN="+metadata.GetWorkspaceOwnerSessionToken(),
		"WIRTUAL_WORKSPACE_TEMPLATE_ID="+metadata.GetTemplateId(),
		"WIRTUAL_WORKSPACE_TEMPLATE_NAME="+metadata.GetTemplateName(),
		"WIRTUAL_WORKSPACE_TEMPLATE_VERSION="+metadata.GetTemplateVersion(),
		"WIRTUAL_WORKSPACE_BUILD_ID="+metadata.GetWorkspaceBuildId(),
	)
