...
// 2. Run "make wirtuald/database/generate" in the root to generate models.
// 3. Add/Edit queries in "query.sql" and run "make wirtuald/database/generate" to create Go code.
package database
