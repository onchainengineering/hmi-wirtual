...
import (
	...
	"github.com/onchainengineering/hmi-wirtual/scaletest/dashboard"
	...
	"github.com/onchainengineering/hmi-wirtual/scaletest/workspacetraffic"
...
func (s *scaletestTracingFlags) attach(opts *serpent.OptionSet) {
	*opts = append(
		*opts,
		...
		serpent.Option{
			Flag:        "trace-coder",
			Env:         "WIRTUAL_SCALETEST_TRACE_CODER",
