...
func TestRedirectHTTPToHTTPSDeprecation(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			name:     "WIRTUAL_TLS_REDIRECT_HTTP=true",
			environ:  serpent.Environ{{Name: "WIRTUAL_TLS_REDIRECT_HTTP", Value: "true"}},
			flags:    []string{},
			expected: true,
		},
		{
			name:     "WIRTUAL_TLS_REDIRECT_HTTP_TO_HTTPS=true",
			environ:  serpent.Environ{{Name: "WIRTUAL_TLS_REDIRECT_HTTP_TO_HTTPS", Value: "true"}},
			flags:    []string{},
			expected: true,
		},
		{
			name:     "WIRTUAL_TLS_REDIRECT_HTTP=false",
			environ:  serpent.Environ{{Name: "WIRTUAL_TLS_REDIRECT_HTTP", Value: "false"}},
			flags:    []string{},
			expected: false,
		},
		{
			name:     "WIRTUAL_TLS_REDIRECT_HTTP_TO_HTTPS=false",
			environ:  serpent.Environ{{Name: "WIRTUAL_TLS_REDIRECT_HTTP_TO_HTTPS", Value: "false"}},
			flags:    []string{},
			expected: false,
		},
		{
