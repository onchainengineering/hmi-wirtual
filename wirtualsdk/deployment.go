...
when required by your organization's security policy.`,
	...
	redirectToAccessURL := serpent.Option{
		...
		Env:         "WIRTUAL_REDIRECT_TO_ACCESS_URL",
	...
	emailAuthIdentity := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_AUTH_IDENTITY",
	...
	emailAuthUsername := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_AUTH_USERNAME",
	...
	emailAuthPassword := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_AUTH_PASSWORD",
	...
	emailAuthPasswordFile := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_AUTH_PASSWORD_FILE",
	...
	emailTLSStartTLS := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_STARTTLS",
	...
	emailTLSServerName := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_SERVERNAME",
	...
	emailTLSSkipCertVerify := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_SKIPVERIFY",
	...
	emailTLSCertAuthorityFile := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_CACERTFILE",
	...
	emailTLSCertFile := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_CERTFILE",
	...
	emailTLSCertKeyFile := serpent.Option{
		...
		Env:         "WIRTUAL_EMAIL_TLS_CERTKEYFILE",
	...
	telemetryEnable := serpent.Option{
		...
		Flag:        "telemetry",
		Env:         "WIRTUAL_TELEMETRY_ENABLE",
		Default:     strconv.FormatBool(flag.Lookup("test.v") == nil || os.Getenv("WIRTUAL_TEST_TELEMETRY_DEFAULT_ENABLE") == "true"),
	...
	opts := serpent.OptionSet{
		...
		},
		{
			...
			Env:         "WIRTUAL_WILDCARD_ACCESS_URL",
		...
		redirectToAccessURL,
		{
			...
			Env:         "WIRTUAL_AUTOBUILD_POLL_INTERVAL",
			Hidden:      true,
		...
		},
		{
			...
			Env:         "WIRTUAL_JOB_HANG_DETECTOR_INTERVAL",
			Hidden:      true,
			Default:     time.Minute.String(),
		...
		},
		{
			...
			Env:         "WIRTUAL_TLS_REDIRECT_HTTP_TO_HTTPS",
			Default:     "true",
			Hidden:      true,
		...
		},
		{
			...
			Env:         "WIRTUAL_TLS_CLIENT_CA_FILE",
		...
		},
		{
			...
			Env:         "WIRTUAL_TLS_CLIENT_CERT_FILE",
		...
		},
		{
			...
			Env:         "WIRTUAL_TLS_CLIENT_KEY_FILE",
		...
		},
		{
			...
			Env:         "WIRTUAL_TLS_ALLOW_INSECURE_CIPHERS",
			Default:     "false",
		...
		// Derp settings
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_ENABLE",
			Default:     "true",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_REGION_ID",
			Default:     "999",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_REGION_CODE",
			Default:     "coder",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_REGION_NAME",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_STUN_ADDRESSES",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_SERVER_RELAY_URL",
		...
		},
		{
			...
			Env:         "WIRTUAL_DERP_FORCE_WEBSOCKETS",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROMETHEUS_ADDRESS",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROMETHEUS_COLLECT_AGENT_STATS",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROMETHEUS_AGGREGATE_AGENT_STATS_BY",
		...
		},
		{
			...
			Env:     "WIRTUAL_PROMETHEUS_COLLECT_DB_METRICS",
		...
		// oAuth settings
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_CLIENT_ID",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_CLIENT_SECRET",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_ALLOWED_ORGS",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_ALLOWED_TEAMS",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_ALLOW_SIGNUPS",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_ALLOW_EVERYONE",
		...
		},
		{
			...
			Env:         "WIRTUAL_OAUTH2_GITHUB_ENTERPRISE_BASE_URL",
		...
		// OIDC settings.
		{
			...
			Env:         "WIRTUAL_OIDC_ALLOW_SIGNUPS",
			Default:     "true",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_CLIENT_SECRET",
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
		...
		},
		{
			...
			Env:   "WIRTUAL_OIDC_CLIENT_KEY_FILE",
		...
		},
		{
			...
			Env:   "WIRTUAL_OIDC_CLIENT_CERT_FILE",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_IGNORE_EMAIL_VERIFIED",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_USERNAME_FIELD",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_AUTH_URL_PARAMS",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_IGNORE_USERINFO",
			Default:     "false",
		...
		},
		{
			...
			Env:  "WIRTUAL_OIDC_ORGANIZATION_FIELD",
		...
		},
		{
			...
			Env:  "WIRTUAL_OIDC_ORGANIZATION_ASSIGN_DEFAULT",
		...
		},
		{
			...
			Env:     "WIRTUAL_OIDC_ORGANIZATION_MAPPING",
			Default: "{}",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_GROUP_MAPPING",
			Default:     "{}",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_GROUP_AUTO_CREATE",
			Default:     "false",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_GROUP_REGEX_FILTER",
			Default:     ".*",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_ALLOWED_GROUPS",
			Default:     "",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_USER_ROLE_FIELD",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_USER_ROLE_MAPPING",
			Default:     "{}",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_USER_ROLE_DEFAULT",
			Default:     "",
		...
		},
		{
			...
			Env:         "WIRTUAL_OIDC_SIGNUPS_DISABLED_TEXT",
		...
		},
		{
			...
			Env:   "WIRTUAL_DANGEROUS_OIDC_SKIP_ISSUER_CHECKS",
		...
		telemetryEnable,
		{
			...
			// was renamed to WIRTUAL_TELEMETRY_ENABLE in the past, but
			// the flag was not renamed -enable.
			Flag:       "telemetry-enable",
			Env:        "WIRTUAL_TELEMETRY",
			Value:      &c.Telemetry.Enable,
			Group:      &deploymentGroupTelemetry,
		...
		},
		{
			...
			Env:         "WIRTUAL_TRACE_HONEYCOMB_API_KEY",
		...
		// Provisioner settings
		{
			...
			Env:         "WIRTUAL_PROVISIONER_DAEMONS",
			Default:     "3",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROVISIONER_DAEMON_POLL_INTERVAL",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROVISIONER_DAEMON_POLL_JITTER",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROVISIONER_FORCE_CANCEL_INTERVAL",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROVISIONER_DAEMON_PSK",
		...
		// RateLimit settings
		{
			...
			Env:         "WIRTUAL_DANGEROUS_DISABLE_RATE_LIMITS",
		...
		},
		{
			...
			// Change the env from the auto-generated WIRTUAL_RATE_LIMIT_API to the
			// old value to avoid breaking existing deployments.
			Env:         "WIRTUAL_API_RATE_LIMIT",
			Flag:        "api-rate-limit",
			Default:     "512",
		...
		},
		{
			...
			Env:         "WIRTUAL_LOGGING_STACKDRIVER",
			Default:     "",
		...
		},
		{
			...
			Env:         "WIRTUAL_ENABLE_TERRAFORM_DEBUG_MODE",
			Default:     "false",
		...
		},
		{
			...
			Env:   "WIRTUAL_ADDITIONAL_CSP_POLICY",
		...
		// ☢️ Dangerous settings
		{
			...
			Env:         "WIRTUAL_DANGEROUS_ALLOW_CORS_REQUESTS",
		...
		},
		{
			...
			Env:         "WIRTUAL_DANGEROUS_ALLOW_PATH_APP_SHARING",
		...
		},
		{
			...
			Env:         "WIRTUAL_DANGEROUS_ALLOW_PATH_APP_SITE_OWNER_ACCESS",
		...
		},
		{
			...
			Env:         "WIRTUAL_MAX_TOKEN_LIFETIME",
		...
		},
		{
			...
			Env:         "WIRTUAL_DEFAULT_TOKEN_LIFETIME",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROXY_TRUSTED_HEADERS",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROXY_TRUSTED_ORIGINS",
		...
		},
		{
			...
			Env:         "WIRTUAL_SECURE_AUTH_COOKIE",
		...
		},
		{
			...
			Env:         "WIRTUAL_TERMS_OF_SERVICE_URL",
		...
		},
		{
			...
			Env:         "WIRTUAL_STRICT_TRANSPORT_SECURITY",
		...
		},
		{
			...
			Env:         "WIRTUAL_STRICT_TRANSPORT_SECURITY_OPTIONS",
		...
		},
		{
			...
			Env:         "WIRTUAL_METRICS_CACHE_REFRESH_INTERVAL",
			Hidden:      true,
		...
		},
		{
			...
			Env:         "WIRTUAL_AGENT_STATS_REFRESH_INTERVAL",
			Hidden:      true,
		...
		},
		{
			...
			Env:         "WIRTUAL_AGENT_FALLBACK_TROUBLESHOOTING_URL",
			Hidden:      true,
		...
		},
		{
			...
			Env:         "WIRTUAL_EXTERNAL_TOKEN_ENCRYPTION_KEYS",
			Annotations: serpent.Annotations{}.Mark(annotationEnterpriseKey, "true").Mark(annotationSecretKey, "true"),
		...
		},
		{
			...
			Env:         "WIRTUAL_DISABLE_OWNER_WORKSPACE_ACCESS",
		...
		},
		{
			...
			Env:         "WIRTUAL_DISABLE_SESSION_EXPIRY_REFRESH",
		...
		},
		{
			...
			Env:         "WIRTUAL_DISABLE_PASSWORD_AUTH",
		...
		},
		{
			...
			Env:         "WIRTUAL_SSH_HOSTNAME_PREFIX",
		...
		},
		{
			...
			Env:    "WIRTUAL_SSH_CONFIG_OPTIONS",
		...
		},
		{
			...
			Env:         "WIRTUAL_CLI_UPGRADE_MESSAGE",
...
Write out the current server config as YAML to stdout.`,
		...
		},
		{
			...
			Env:         "WIRTUAL_QUIET_HOURS_DEFAULT_SCHEDULE",
		...
		},
		{
			...
			Env:         "WIRTUAL_ALLOW_CUSTOM_QUIET_HOURS",
			Default:     "true",
		...
		},
		{
			...
			Env:         "WIRTUAL_WEB_TERMINAL_RENDERER",
			Default:     "canvas",
		...
		},
		{
			...
			Env:         "WIRTUAL_ALLOW_WORKSPACE_RENAMES",
			Default:     "false",
		...
		// Healthcheck Options
		{
			...
			Env:         "WIRTUAL_HEALTH_CHECK_REFRESH",
			Default:     (10 * time.Minute).String(),
		...
		},
		{
			...
			Env:         "WIRTUAL_HEALTH_CHECK_THRESHOLD_DATABASE",
		...
		// Notifications Options
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_METHOD",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_DISPATCH_TIMEOUT",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_FROM",
			Value:       &c.Notifications.SMTP.From,
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_SMARTHOST",
			Value:       &c.Notifications.SMTP.Smarthost,
			Group:       &deploymentGroupNotificationsEmail,
			YAML:        "smarthost",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_HELLO",
			Value:       &c.Notifications.SMTP.Hello,
			Group:       &deploymentGroupNotificationsEmail,
			YAML:        "hello",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_FORCE_TLS",
			Value:       &c.Notifications.SMTP.ForceTLS,
			Group:       &deploymentGroupNotificationsEmail,
			YAML:        "forceTLS",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_IDENTITY",
			Value:       &c.Notifications.SMTP.Auth.Identity,
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_USERNAME",
			Value:       &c.Notifications.SMTP.Auth.Username,
			Group:       &deploymentGroupNotificationsEmailAuth,
			YAML:        "username",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_PASSWORD",
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
			Value:       &c.Notifications.SMTP.Auth.Password,
			Group:       &deploymentGroupNotificationsEmailAuth,
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_PASSWORD_FILE",
			Value:       &c.Notifications.SMTP.Auth.PasswordFile,
			Group:       &deploymentGroupNotificationsEmailAuth,
			YAML:        "passwordFile",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_STARTTLS",
			Value:       &c.Notifications.SMTP.TLS.StartTLS,
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_SERVERNAME",
			Value:       &c.Notifications.SMTP.TLS.ServerName,
			Group:       &deploymentGroupNotificationsEmailTLS,
			YAML:        "serverName",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_SKIPVERIFY",
			Value:       &c.Notifications.SMTP.TLS.InsecureSkipVerify,
			Group:       &deploymentGroupNotificationsEmailTLS,
			YAML:        "insecureSkipVerify",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CACERTFILE",
			Value:       &c.Notifications.SMTP.TLS.CAFile,
			Group:       &deploymentGroupNotificationsEmailTLS,
			YAML:        "caCertFile",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CERTFILE",
			Value:       &c.Notifications.SMTP.TLS.CertFile,
			Group:       &deploymentGroupNotificationsEmailTLS,
			YAML:        "certFile",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CERTKEYFILE",
			Value:       &c.Notifications.SMTP.TLS.KeyFile,
			Group:       &deploymentGroupNotificationsEmailTLS,
			YAML:        "certKeyFile",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_WEBHOOK_ENDPOINT",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_MAX_SEND_ATTEMPTS",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_RETRY_INTERVAL",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_STORE_SYNC_INTERVAL",
		...
		},
		{
			...
			Env:     "WIRTUAL_NOTIFICATIONS_STORE_SYNC_BUFFER_SIZE",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_LEASE_PERIOD",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_LEASE_COUNT",
		...
		},
		{
			...
			Env:         "WIRTUAL_NOTIFICATIONS_FETCH_INTERVAL",
