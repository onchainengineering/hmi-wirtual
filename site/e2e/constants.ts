...
export const coderPort = process.env.WIRTUAL_E2E_PORT
	? Number(process.env.WIRTUAL_E2E_PORT)
	: 3111;
...
export const premiumTestsRequired = Boolean(
	process.env.WIRTUAL_E2E_REQUIRE_PREMIUM_TESTS,
);

export const license = process.env.WIRTUAL_E2E_LICENSE ?? "";
...
export const requireTerraformTests = !process.env.WIRTUAL_E2E_DISABLE_TERRAFORM;
