...
func (r *RootCmd) provisionerDaemonStart() *serpent.Command {
	...
	keyOption := serpent.Option{
		Flag:        "key",
		Env:         "WIRTUAL_PROVISIONER_DAEMON_KEY",
	...
	cmd.Options = serpent.OptionSet{
		...
		{
			Flag:        "poll-interval",
			Env:         "WIRTUAL_PROVISIONERD_POLL_INTERVAL",
		...
		{
			Flag:        "poll-jitter",
			Env:         "WIRTUAL_PROVISIONERD_POLL_JITTER",
			Description: "Deprecated and ignored.",
		...
		{
			Flag:        "name",
			Env:         "WIRTUAL_PROVISIONER_DAEMON_NAME",
		...
		{
			Flag:        "verbose",
			Env:         "WIRTUAL_PROVISIONER_DAEMON_VERBOSE",
		...
		{
			Flag:        "log-human",
			Env:         "WIRTUAL_PROVISIONER_DAEMON_LOGGING_HUMAN",
		...
		{
			Flag:        "log-json",
			Env:         "WIRTUAL_PROVISIONER_DAEMON_LOGGING_JSON",
		...
		},
		{
			...
			Env:         "WIRTUAL_PROVISIONER_DAEMON_LOGGING_STACKDRIVER",
		...
		{
			Flag:        "log-filter",
			Env:         "WIRTUAL_PROVISIONER_DAEMON_LOG_FILTER",
