...
| `WIRTUAL_AGENT_TOKEN`        | The [Coder Agent](https://coder.com/docs/about/architecture#agents) token to pass to the inner container.                                                                                                                                                                                                                                                                                                                                                                       | True     |
...
| `WIRTUAL_MOUNTS`             | A list of mounts to mount into the inner container. Mounts default to `rw`. Ex: `WIRTUAL_MOUNTS=/home/coder:/home/coder,/var/run/mysecret:/var/run/mysecret:ro`                                                                                                                                                                                                                                                                                                                   | false    |
