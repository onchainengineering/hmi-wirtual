...
- Enterprise deployments can create templates without 'everyone' group access
  (#7982)
  ![Disable "everyone"](https://github.com/onchainengineering/hmi-wirtual/assets/22407953/1c31cb9b-be5c-4bef-abee-324856734215)
...
- Queue position of pending workspace builds are shown in the dashboard (#8244)
  <img width="1449" alt="Queue position" src="https://github.com/onchainengineering/hmi-wirtual/assets/22407953/44515a19-ddfb-4431-8c2a-203487c4efe8">
...
- Users can convert from username/password accounts to OIDC accounts in Account
  settings (#8105) (@Emyrk)
  ![Convert account](https://github.com/onchainengineering/hmi-wirtual/assets/22407953/6ea28c1c-53d7-4eb5-8113-9a066739820c)
...
Compare:
[`v0.24.1...v0.25.0`](https://github.com/onchainengineering/hmi-wirtual/compare/v0.24.1...v0.25.0)
