...
- Add a user-configurable theme picker (#11140) (@aslilac)
  ...
  > A [light theme](https://github.com/onchainengineering/hmi-wirtual/issues/8396) is coming soon
...
Compare: [`v2.5.0...v2.5.1`](https://github.com/onchainengineering/hmi-wirtual/compare/v2.5.0...v2.5.1)
