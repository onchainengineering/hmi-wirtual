...
> [!NOTE]
> This is a mainline Coder release. We advise enterprise customers without a staging environment to install our [latest stable release](https://github.com/onchainengineering/hmi-wirtual/releases/latest) while we refine this version. Learn more about our [Release Schedule](../install/releases.md).
...
- CLI: Handle CLI default organization when none exists in <v2.9.0 wirtuald (#12594) (@Emyrk)
...
Compare: [`v2.9.0...v2.10.0`](https://github.com/onchainengineering/hmi-wirtual/compare/v2.9.0...v2.10.0)
