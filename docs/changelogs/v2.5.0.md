...
- Disable WIRTUAL_DERP_SERVER_STUN_ADDRESSES correctly (#10840) (@strike)
...
- Align WIRTUAL_HTTP_ADDRESS with document (#10779) (@JounQin)
- Migrate all deprecated `WIRTUAL_ADDRESS `to `WIRTUAL_HTTP_ADDRESS` (#10780) (@JounQin)
