...
- Remove prometheus-http port declaration from wirtuald service spec (#12214) (@johnstcn)
...
Compare: [`v2.8.5...v2.9.0`](https://github.com/onchainengineering/hmi-wirtual/compare/v2.8.5...v2.9.0)
