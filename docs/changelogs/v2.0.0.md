...
previous [coder/coder](https://github.com/onchainengineering/hmi-wirtual) release, but we feel like
...
- Kubernetes (Helm): The
  [default ServiceAccount](https://github.com/onchainengineering/hmi-wirtual/blob/8d0e8f45e0fb3802d777a396b4c027ab9788e1b8/helm/values.yaml#L67-L82)
  for Coder can provision `Deployments` on the cluster. (#8704) (@ericpaulsen)
  - This can be disabled by a
    [Helm value](https://github.com/onchainengineering/hmi-wirtual/blob/8d0e8f45e0fb3802d777a396b4c027ab9788e1b8/helm/values.yaml#L78)
  - Our
    [Kubernetes example template](https://github.com/onchainengineering/hmi-wirtual/tree/main/examples/templates/kubernetes)
...
- Sever logs: Added fine-grained
  ...
  Regex (#8748) (@ammario)
- d3991fac2 feat(wirtuald): add parameter insights to template insights (#8656)
  (@mafredri)
...
- [Open in Coder](https://coder.com/docs/templates/open-in-wirtual):
...
- Make [pgCoordinator](https://github.com/onchainengineering/hmi-wirtual/pull/8044) experimental
  again (#8797) (@coadler)

Compare:
[`v0.27.0...v2.0.0`](https://github.com/onchainengineering/hmi-wirtual/compare/v0.27.0...v2.0.0)
