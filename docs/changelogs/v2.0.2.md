...
- [External provisioners](https://coder.com/docs/admin/provisioners)
  ...
  - Provisioner daemons can be deployed
    [via Helm](https://github.com/onchainengineering/hmi-wirtual/tree/main/helm/provisioner)
    (#8939) (@spikecurtis)
...
- We now publish preview
  [container images](https://github.com/onchainengineering/hmi-wirtual/pkgs/container/coder-preview)
...
Compare:
[`v2.0.1...v2.0.2`](https://github.com/onchainengineering/hmi-wirtual/compare/v2.0.1...v2.0.2)
