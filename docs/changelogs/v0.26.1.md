...
- [pgCoordinator](https://github.com/onchainengineering/hmi-wirtual/pull/8044) is generally
  available (#8419)
...
Compare:
[`v0.26.0...v0.26.1`](https://github.com/onchainengineering/hmi-wirtual/compare/v0.26.0...v0.26.1)
