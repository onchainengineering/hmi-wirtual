...
> [GitHub repo](https://github.com/onchainengineering/hmi-wirtual/tree/main/examples/templates).

## Community Templates

As well as Coder's starter templates, you can see a list of community templates
by our users
[here](https://github.com/onchainengineering/hmi-wirtual/blob/main/examples/templates/community-templates.md).
