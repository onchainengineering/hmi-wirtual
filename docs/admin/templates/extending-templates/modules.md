...
[here](https://github.com/onchainengineering/hmi-wirtual/blob/main/examples/jfrog/remote/main.tf)
that uses our
[JFrog Docker](https://github.com/onchainengineering/hmi-wirtual/blob/main/examples/jfrog/docker/main.tf)
