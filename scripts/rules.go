...
func dbauthzAuthorizationContext(m dsl.Matcher) {
	m.Import("context")
	m.Import("github.com/onchainengineering/hmi-wirtual/wirtuald/database/dbauthz")
...
func testingWithOwnerUser(m dsl.Matcher) {
	m.Import("testing")
	m.Import("github.com/onchainengineering/hmi-wirtual/cli/clitest")
	m.Import("github.com/onchainengineering/hmi-wirtual/enterprise/wirtuald/coderenttest")
...
func databaseImport(m dsl.Matcher) {
	m.Import("github.com/onchainengineering/hmi-wirtual/wirtuald/database")
	m.Match("database.$_").
		Report("Do not import any database types into wirtualsdk").
		Where(m.File().PkgPath.Matches("github.com/onchainengineering/hmi-wirtual/wirtualsdk"))
}
...
func useStandardTimeoutsAndDelaysInTests(m dsl.Matcher) {
	...
	m.Import("github.com/onchainengineering/hmi-wirtual/testutil")
...
func HttpAPIErrorMessage(m dsl.Matcher) {
	m.Import("github.com/onchainengineering/hmi-wirtual/wirtuald/httpapi")
...
func noPTYInAgent(m dsl.Matcher) {
	m.Import("github.com/onchainengineering/hmi-wirtual/pty")
	m.Match(
		`pty.Command($*_)`,
